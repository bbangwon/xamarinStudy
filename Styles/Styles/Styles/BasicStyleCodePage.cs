                    ...
                    "buttonStyle", new Style(typeof(Button))
                    {
                        Setters=
                        {
                            ...
                            new Setter
                            {
                                ...
                                Value = (Device.RuntimePlatform == Device.iOS)?Color.FromRgb(0x40, 0x40, 0x40):Color.Default
                            },
                            new Setter
                            {
                                Property = Button.BorderColorProperty,
                                Value = (Device.RuntimePlatform == Device.iOS)?Color.Default:(Device.RuntimePlatform == Device.Android)?Color.White:Color.Black
                            }
                        }
                    }
                }
